...
def inspect_header(header_path):
    ...
    contents = io.open(header_path, mode='r', encoding='utf-8').read()
...
def fromGrcParam(grc_param):
    ...
    optsHaveSize = opts and len(opts[0])==1 and (opts[0][0].startswith('size') or opts[0][0].startswith('itemsize'))
